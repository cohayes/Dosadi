...
DEFAULT_RECIPES: list[Recipe] = [
    ...
    _recipe(
        recipe_id="chemlab_sealant_batch_t2",
        facility_kind=FacilityKind.CHEM_LAB_T2,
        inputs={Material.CHEM_SALTS: 3, Material.FIBER: 1},
        outputs={Material.SEALANT: 4, Material.GASKETS: 2},
        tags={"parts", "chem"},
        notes="CHEM_SALTS/FIBER -> SEALANT/GASKETS",
        requires_unlocks={"UNLOCK_CHEM_SEALANTS_T2"},
    ),
    _recipe(
        recipe_id="workshop_t2_fasteners_fittings",
        facility_kind=FacilityKind.WORKSHOP_T2,
        inputs={Material.SCRAP_METAL: 6},
        outputs={Material.FASTENERS: 4, Material.FITTINGS: 2, Material.METAL_PLATE: 2},
        min_staff=1,
        tags={"parts", "industry"},
        notes="SCRAP_METAL -> FASTENERS/FITTINGS/METAL_PLATE",
        requires_unlocks={"UNLOCK_WORKSHOP_PARTS_T2"},
    ),
    _recipe(
        recipe_id="workshop_t2_filter_media",
        facility_kind=FacilityKind.WORKSHOP_T2,
        inputs={Material.FIBER: 6},
        outputs={Material.FILTER_MEDIA: 3},
        min_staff=1,
        tags={"parts", "filters"},
        notes="FIBER -> FILTER_MEDIA (T2)",
        requires_unlocks={"UNLOCK_WORKSHOP_PARTS_T2"},
    ),
    _recipe(
        recipe_id="fabshop_adv_components",
        facility_kind=FacilityKind.FAB_SHOP_T3,
        inputs={Material.FASTENERS: 1, Material.SEALANT: 1, Material.METAL_PLATE: 1},
        outputs={Material.ADV_COMPONENTS: 1},
        min_staff=1,
        tags={"parts", "fabrication"},
        notes="FASTENERS/SEALANT/METAL_PLATE -> ADV_COMPONENTS",
