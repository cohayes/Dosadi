...
# Work preference review cadence
PREFERENCE_REVIEW_INTERVAL_TICKS: int = 120_000  # ~once per "day"
NEGATIVE_PREFERENCE_THRESHOLD: float = -0.3
POSITIVE_PREFERENCE_THRESHOLD: float = 0.3
